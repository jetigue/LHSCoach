<template>
    <div class="flex flex-col w-full">
        <header class="w-full lg:text-2xl py-4 text-gray-900 text-center">Spring Sports</header>
                    ...
                    <div v-show="active" class="flex w-full fixed inset-0 overflow-auto z-50 bg-gray-700 bg-opacity-75">
                        <div class="relative bg-white w-full md:w-2/3 lg:w-1/3 h-full md:h-auto m-auto md:rounded flex flex-col p-4">
                            ...
                            <section class="my-3 p-4 bg-gray-200 rounded-lg">
                                <new-spring-sport @created="add"></new-spring-sport>
                            </section>
...
<script>
    ...
    import SpringSport from "./SpringSport";
    import NewSpringSport from "../forms/NewSpringSport";

    export default Collection.extend({
        name: "SpringSports",
        components: {SpringSport, NewSpringSport},
